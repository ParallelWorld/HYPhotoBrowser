...
#pragma mark 显示信息
+ (void)mj_show:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
...
+ (void)mj_showError:(NSString *)error toView:(UIView *)view{
    [self mj_show:error icon:@"error.png" view:view];
}

+ (void)mj_showSuccess:(NSString *)success toView:(UIView *)view
{
    [self mj_show:success icon:@"success.png" view:view];
}
